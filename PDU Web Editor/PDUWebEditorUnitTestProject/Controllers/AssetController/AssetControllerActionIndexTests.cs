...
namespace PDU_Web_Editor.ControllersTestSet.Tests
{
    ...
    public class AssetControllerActionIndexTests
    {
        ...
        #endregion
        [TestMethod()]
        public void IndexTest_AssetIndexViewIsLoaded()
        {
            //arrange

            //act
            ViewResult viewResult = _assetController.Index() as ViewResult;
            //assert
