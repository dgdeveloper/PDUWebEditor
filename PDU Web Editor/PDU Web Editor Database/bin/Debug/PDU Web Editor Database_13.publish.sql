...
GO
ALTER TABLE [dbo].[tbl_Assets] ALTER COLUMN [Ast_UpdatedOnDate] DATETIME2 (7) NOT NULL;
...
GO
ALTER TABLE [dbo].[tbl_PDUs] ALTER COLUMN [Pdu_UpdateOnDate] DATETIME2 (7) NOT NULL;
