...
IF EXISTS (select top 1 1 from [dbo].[tbl_Records])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
PRINT N'Dropping [dbo].[fk_Rec_PDUUniqueId]...';


GO
ALTER TABLE [dbo].[tbl_Records] DROP CONSTRAINT [fk_Rec_PDUUniqueId];
...
GO
PRINT N'Altering [dbo].[tbl_Assets]...';


GO
ALTER TABLE [dbo].[tbl_Assets] ALTER COLUMN [Ast_UpdatedOnDate] NVARCHAR (50) NOT NULL;
...
GO
ALTER TABLE [dbo].[tbl_Records] ALTER COLUMN [Rec_PDUUniqueId] INT NOT NULL;
